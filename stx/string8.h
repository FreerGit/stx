...
// NOTE: this does not terminate the String8 with a 0 as that would destroy the original String8.
...
String8 string_replace(String8 s, String8 match, String8 replacement, Allocator *a) {
  (void)s;
  (void)match;
  (void)replacement;
  (void)a;
